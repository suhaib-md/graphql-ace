...
export function MainPanel({
  ...
  const responseDisplay = React.useMemo(() => {
    if (!response) {
      return <span className='text-muted-foreground font-sans px-4'>Click "Run" to send a request.</span>;
    }
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 px-4 pb-4 min-h-0">
        ...
        <div className="flex flex-col gap-4 lg:w-[40%] min-h-0">
          {/* Query Panel - Takes 70% of left side height */}
          <Card className="flex flex-col flex-[7]">
            <CardHeader className="py-3 px-4">
              <CardTitle className="text-base">Query</CardTitle>
            </CardHeader>
            <CardContent className="flex-1 p-0 pb-2 px-2 min-h-0">
              <Textarea
          ...
          {/* Variables Panel - Takes 30% of left side height */}
        ...
        {/* Right side - Response Panel - Takes remaining 60% */}
        <Card className="flex flex-col lg:w-[60%] min-h-0">
          ...
          <CardContent className="flex-1 min-h-0 p-2">
            <ScrollArea className="h-full rounded-md bg-secondary/20">
              ...
              <pre className="text-sm font-code p-4 h-full">
                {responseDisplay}
              </pre>
            </ScrollArea>
          </CardContent>
